...
public class CustomAdapterGrpQue extends SimpleAdapter {
    ...
    public CustomAdapterGrpQue(Context context, ArrayList<HashMap<String, String>> data, int resource, String[] from, int[] to) {
...
//        });
        ...
        TextView question = (TextView) view.findViewById(R.id.grpQueTextView);
        RadioButton yes = (RadioButton) view.findViewById(R.id.grpQueYesRadBtn);
        RadioButton no = (RadioButton) view.findViewById(R.id.grpQueNoRadBtn);
...
//        });
        ...
        RadioGroup radioG=(RadioGroup) view.findViewById(R.id.radioGroupGrpQue);
